...
@Component({
    ...
    template: `
        <div class="form-inline ng2-datetime">
            <div [ngClass]="{ 'form-group': true, 'input-group': !datepickerOptions.hideIcon, 'date': true }" style="
            width:100%;">
                ...
                <div [hidden]="datepickerOptions.hideIcon || datepickerOptions === false"
                    ...
                    <span [ngClass]="datepickerOptions.icon || 'glyphicon glyphicon-th'" style="
                    padding: 4px;"></span>
                </div>
            </div>
            <div [ngClass]="{ 'form-group': true, 'input-group': !timepickerOptions.hideIcon, 'bootstrap-timepicker timepicker': true }" style="
            width:100%;">
                <input id="{{idTimePicker}}" type="text" class="form-control input-small"
                       ...
                       (blur)="onTouched()"
                       (keyup)="checkEmptyValue($event)">
                <span [hidden]="timepickerOptions.hideIcon || false" class="input-group-addon" style="
                padding: 10px 13px;">
